...
@pytest.mark.parametrize(
    ...
    [
        (["https://jovian.com"], "https://jovian.com"),
        (["https://jovian.com/"], "https://jovian.com/"),
        (["///user/siddhant"], "user/siddhant"),
        (["https://jovian.com", "user/siddhant"], "https://jovian.com/user/siddhant"),
        (["https://jovian.com", "/user/siddhant"], "https://jovian.com/user/siddhant"),
        (["https://jovian.com/", "user/siddhant"], "https://jovian.com/user/siddhant"),
        (["https://jovian.com/", "/user/siddhant"], "https://jovian.com/user/siddhant"),
        (["https://jovian.com", "user/siddhant/"], "https://jovian.com/user/siddhant/"),
        ...
        (["https://jovian.com/", "/user/siddhant/"], "https://jovian.com/user/siddhant/"),
        (["https://jovian.com/", "///user/siddhant/////"], "https://jovian.com/user/siddhant/"),
        (["https://jovian.com/", "user/siddhant/", "/gists/starred"], "https://jovian.com/user/siddhant/gists/starred"),
    ]
)
