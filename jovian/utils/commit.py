...
from jovian.utils.kaggle import is_kaggle_batch, is_kaggle_interactive, perform_kaggle_commit
...
def commit(message=None,
    ...
    if kwargs.get('check_kaggle', True) and is_kaggle_interactive():
