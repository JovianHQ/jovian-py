...
from jovian.utils.kaggle import in_kaggle, is_kaggle_batch, is_kaggle_interactive, perform_kaggle_commit
...
def commit(message=None,
    ...
    check_kaggle = kwargs.get('check_kaggle', is_kaggle_interactive())
