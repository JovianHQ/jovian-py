...
FILENAME_MSG = 'Failed to detect notebook filename. Re-run this cell to try again or provide the notebook filename ' + \
    'during commit e.g. jovian.commit(filename="jupyter-notebook-filename.ipynb")'
